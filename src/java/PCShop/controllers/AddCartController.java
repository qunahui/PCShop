...
public class AddCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String path = request.getParameter("txtProPath");
        double price = Double.parseDouble(request.getParameter("txtProPrice"));
        int quantity = Integer.parseInt(request.getParameter("txtProQuantity"));
        double discount = Double.parseDouble(request.getParameter("txtProDiscount"));
        try {
            ...
            ProductObj pro = new ProductObj(ID,categoryID,description,name,price,quantity,discount,path);
            cart.addProductToCart(pro);
