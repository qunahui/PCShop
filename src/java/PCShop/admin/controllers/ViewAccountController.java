 ...
 * @author Hui
 */
@WebServlet(name = "AdminViewAccountController", urlPatterns = {"/admin/ViewAccountController"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           request.setAttribute("SEARCHRESULT", result);
            ...
            request.getRequestDispatcher("account/search.jsp").forward(request, response);
        }
    }
