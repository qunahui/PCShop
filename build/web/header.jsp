        ...
        <div class="collapse navbar-collapse justify-content-center align-items-center" id="navbarSupportedContent">
          ...
          <c:if test="${sessionScope.USERNAME == null}">
              <form class="form-inline my-2 my-lg-0" action="MainController" method="POST">
                <button class="btn btn-outline-success my-2 my-sm-0" style="margin-left: 5px;" type="button" data-toggle="modal" data-target="#loginModal" id="openLoginModalBtn">Login</button>
                <button class="btn btn-outline-success my-2 my-sm-0" style="margin-left: 5px;" type="button" data-toggle="modal" data-target="#registerModal" id="openRegisterModalBtn">Register</button>
                <button class="btn btn-outline-success my-2 my-sm-0" style="margin-left: 5px;" type="submit" value="Register" name="btnAction">Sign up</button>
          ...
          <div class="modal-content">
            ...
            <form method="POST" action="MainController" id="addAccountForm"> 
                ...
                <div class="modal-footer justify-content-center align-items-center">
                    ...
                    <button class="btn btn-outline-success my-2 my-sm-0" style="margin-left: 5px;" type="button" id="reset">Reset</button>
                    <input type="submit" value="Create New Account" name="action" class="btn btn-outline-success my-2 my-sm-0" style="margin-left: 5px;"  />
                </div>
            </form>
          </div>
        </div>
